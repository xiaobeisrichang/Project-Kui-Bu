...
TEAM_MEMBERS = ["小北", "颖欣", "同事B", "同事C"]
BUSINESS_MODULES = {
    "01_会员等级与账户": ["注册/登录", "升级/降级", "等级定义", "账户合并", "账号风险等级", "其它"],
    "02_离店订单权益赠送": ["赠送规则", "去重逻辑", "赠送频次", "有效期", "其它"],
    "03_会员积分": ["积分有效期", "待领取积分", "积分发放", "其它"],
    "04_会员礼包": ["礼包类型", "礼包权益", "其它"],
    "05_会员营销活动": ["会籍挑战", "礼包活动", "其它"],
    "06_消息触达": ["事务短信", "营销短信", "公众号消息", "其它"],
    "11_技术接口文档": ["对外规范", "字段映射", "加解密", "回调机制"],
    "13_技术底层规范定义": ["证件枚举", "脱敏规则", "报错文案"],
    "15_其他": ["其他"]
}
